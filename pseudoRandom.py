...
class pseudoRandom:
    ...
    def randBytes(self, length=1, readable=False):
        """
        ...
        :return: A bytes object containing the generated pseudo-random bytes.
        """
        min_val, max_val = (32, 126) if readable else (0, 255)
        return bytes([self.randInt(min_val, max_val) for _ in range(length)])
